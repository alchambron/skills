...
35 skills organized by purpose. Each skill folder includes its original instructions and supporting files. Some skills contain JouleMV conventions or depend on specific tools and services; see their `SKILL.md` for requirements.
...
| [Git and review workflow](git-and-review-workflow/) | Publish reviews, manage review queues, resolve conflicts, and ship changes | [github-inline-review](git-and-review-workflow/github-inline-review/SKILL.md), [joulemv-review-queue](git-and-review-workflow/joulemv-review-queue/SKILL.md), [resolving-merge-conflicts](git-and-review-workflow/resolving-merge-conflicts/SKILL.md), [yeet](git-and-review-workflow/yeet/SKILL.md) |
...
The bundled skill validator rejects existing `disable-model-invocation` metadata in `handoff`, `grill-with-docs`, and `improve-codebase-architecture`, plus `argument-hint` in `handoff`. These fields are preserved from the source skills. All 35 frontmatter blocks parse as YAML; 32 skills pass the bundled validator.
